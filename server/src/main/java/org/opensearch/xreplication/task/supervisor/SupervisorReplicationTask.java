...
import org.opensearch.xreplication.actions.followers.StartCCRFollowerTaskRequest;
import org.opensearch.xreplication.actions.index.StartCCRIndexTaskAction;
import org.opensearch.xreplication.actions.index.StartCCRIndexTaskRequest;
...
public class SupervisorReplicationTask extends AllocatedPersistentTask {
    ...
    private void createIndexTasks(String[] indices) {
        ...
        StartCCRIndexTaskRequest startCCRIndexTaskRequest = new StartCCRIndexTaskRequest(indices, followers);
        client.execute(StartCCRIndexTaskAction.INSTANCE, startCCRIndexTaskRequest);
    }

    private void createFollowerTasks(String[] followers) {
        logger.info("creating followers {}", Arrays.toString(followers));
        StartCCRFollowerTaskRequest startCCRFollowerTaskRequest = new StartCCRFollowerTaskRequest(followers);
        client.execute(StartCCRFollowerTaskAction.INSTANCE, startCCRFollowerTaskRequest);
    }
}
