...
import org.opensearch.xreplication.task.supervisor.SupervisorReplicationTask;
...
public class IndexReplicationTask extends AllocatedPersistentTask {
    ...
    private void createFollowerIndex() {
        ...
        followerSettingsBuilder.put(IndexMetadata.FOLLOWER_INDEX_SETTING.getKey(), true);
